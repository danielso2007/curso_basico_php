...
$usuario = new app\model\Usuario($_POST['nome'], $_POST['senha'], $_POST['genero']);
$contato = new app\model\Contato($_POST['email'], $_POST['endereco'], $_POST['cep'], $_POST['telefone'])
...
<body>
    ...
    <div class="mx-5 my-5">
        ...
        <p><?= htmlspecialchars($usuario->getGenero()); ?>, seguem os dados de sua conta:</p>
        <ul class="list-group">
            ...
            <li class="list-group-item">Senha: <?= htmlspecialchars($usuario->getPassword()); ?></li>
            ...
            <li class="list-group-item">Endereço: <?= htmlspecialchars($contato->getEndereco()); ?></li>
        </ul>
    </div>
</body>
